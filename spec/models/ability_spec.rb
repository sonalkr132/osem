...
describe 'User' do
  describe 'Abilities' do
    ...
    context 'when user is not signed in' do
      ...
      let(:conference_with_closed_registration) { create(:conference, registration_period: closed_registration_period) }
      let(:closed_registration_period) { create(:registration_period, start_date: Date.current - 6.days, end_date: Date.current - 6.days) }
